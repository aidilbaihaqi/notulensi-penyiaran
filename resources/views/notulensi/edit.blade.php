...
<div class="row">
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Ubah Notulensi Penyiaran</h4>
        <p class="card-description">
          Form perubahan notulensi penyiaran
        </p>
        <div>
          <form action="{{ route('notulensi.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div>
              ...
              <div class="col-md-6 col-sm-6 ">
                <textarea name="notulen" id="notulen" cols="30" rows="10">{!! $data->notulen !!}</textarea>
              </div>
            </div>
            <div class="mt-4">
              <div class="col-md-6 col-sm-6">
